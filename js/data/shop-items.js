...
export const shopItems = [
    ...
    { name: 'Épée Rouillée', icon: '⚔️', description: '1 de dégât\n✨ +1 Force', cost: 40, category: 'equipment', type: 'weapon', classRestriction: 'ranger', bonus: 1, rarity: 'commun', effect: null },
    { name: 'Épée en Fer', icon: '⚔️', description: '3 de dégât\n✨ +1 Force', cost: 80, category: 'equipment', type: 'weapon', classRestriction: 'ranger', bonus: 3, rarity: 'commun', effect: null },
    { name: 'Épée en Acier', icon: '⚔️', description: '5 de dégât\n✨ +1 Force', cost: 130, category: 'equipment', type: 'weapon', classRestriction: 'ranger', bonus: 5, rarity: 'rare', effect: null },
    { name: 'Épée Enchantée', icon: '⚔️', description: '7 de dégât\n✨ +1 Force', cost: 200, category: 'equipment', type: 'weapon', classRestriction: 'ranger', bonus: 7, rarity: 'rare', effect: null },
    { name: 'Épée Flamboyante', icon: '⚔️', description: '9 de dégât\n✨ +1 Force', cost: 290, category: 'equipment', type: 'weapon', classRestriction: 'ranger', bonus: 9, rarity: 'epique', effect: null },
    { name: 'Épée Runique', icon: '⚔️', description: '10 de dégât\n✨ +1 Force', cost: 550, category: 'equipment', type: 'weapon', classRestriction: 'ranger', bonus: 10, rarity: 'epique', effect: null },
    { name: 'Épée Légendaire', icon: '⚔️', description: '12 de dégât\n✨ +1 Force', cost: 850, category: 'equipment', type: 'weapon', classRestriction: 'ranger', bonus: 12, rarity: 'legendaire', effect: null },
    { name: 'Épée Divine', icon: '⚔️', description: '15 de dégât\n✨ +1 Force', cost: 1250, category: 'equipment', type: 'weapon', classRestriction: 'ranger', bonus: 15, rarity: 'legendaire', effect: null },
    { name: 'Épée Céleste', icon: '⚔️', description: '18 de dégât\n✨ +1 Force', cost: 1800, category: 'equipment', type: 'weapon', classRestriction: 'ranger', bonus: 18, rarity: 'legendaire', effect: null },
    { name: 'Épée du Conquérant Suprême', icon: '⚔️', description: '22 de dégât\n✨ +1 Force', cost: 2500, category: 'equipment', type: 'weapon', classRestriction: 'ranger', bonus: 22, rarity: 'legendaire', effect: null },
